const projects = [
  ...
  },
  {
    title: "Seuphoria",
    description:
      "A makeup e-commerce with cool parallax effects built with TypeScript, React, Redux, Tailwind, Node, Express, Mongo and Mongoose.",
    stack: [
      "typescript",
      "react",
      "redux",
  ...
  },  
  {
    title: "Portfolio",
    description:
      "This website is a React app styled with SASS and animated using the Framer Motion library.",
    stack: ["react", "sass"],
    gitRepo: [
